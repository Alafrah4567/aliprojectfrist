...
let musdar = document.querySelector('.musdar')
...
let musdari = function()
{
  musdar.classList.remove('musdar')
}
let musddar=function(){
  musdar.classList.add('musdar')
}

menu.addEventListener("click", getopen );
xbs.addEventListener("click", getclose);
//opencrud.addEventListener('click',crudsystem)
opencrud.addEventListener("click", close ,musdari);
opencrud.addEventListener('click',crudsystem , )
mainpro.addEventListener('click', musdari )
containerx.addEventListener('click',closemainpro);
products.addEventListener('click',home);
